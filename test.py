...
block_two_dir = {
                  ...
                  "prev_hash": "00000c575050241e0a4df1acd7e6fb90cc1f599e2cc2908ec8225e10915006cc",
                  "data": "I block #2"
                }
...
mine_test_chain = Chain([mine_test_block_zero,
                         mine_test_block_one,
                         mine_test_block_two,
                         mine_test_block_three])
...
with freeze_time(ft):
  ...
  new_block, rounds, start_nonce = mine.mine_block(poss_block_one,
                                                   rounds=1000,
                                                   start_nonce=1685000)
  ...
  new_block, rounds, start_nonce = mine.mine_from_prev_block(mine_test_block_zero,
                                                             rounds=1000,
                                                             start_nonce=0)
  assert not new_block
  assert rounds == 1000
  ...
  new_block, rounds, start_nonce = mine.mine_for_block(chain=mine_test_zero_chain,
                                                       rounds=1000,
                                                       start_nonce=0)
  assert not new_block
  assert rounds == 1000
